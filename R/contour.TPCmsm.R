contour.TPCmsm <- function(
  x, contour.type="tc", tr.choice, nlevels=20, levels=pretty(zlim, nlevels),
  ...
  if ( !( contour.type %in% c("tc", "ct") ) )
    stop("Argument 'contour.type' must be one of 'tc' or 'ct'");
